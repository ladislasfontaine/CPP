...
/*   Updated: 2020/07/17 15:54:04 by lafontai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool		Form::checkBeforeExecution(Bureaucrat const & executor) const {
	if (!this->getSigned()) {
		std::cout << "Form " << this->getName() << " needs to be signed before execution." << std::endl;
		return (false);
	}
